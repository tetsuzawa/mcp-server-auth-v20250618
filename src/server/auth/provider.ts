...
export interface OAuthServerProvider {
   ...
   * 
   * @returns Response object for Hono to handle the redirect
   */
  authorize(client: OAuthClientInformationFull, params: AuthorizationParams, c: Context): Promise<Response>;
